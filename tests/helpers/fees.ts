...
export function computeFwdFees(
    msgPrices: ReturnType<typeof configParseMsgPrices>,
    cells: bigint,
    bits: bigint
) {
...
export function computeCellForwardFees(
    msgPrices: ReturnType<typeof configParseMsgPrices>,
    msg: Cell
) {
...
export function computeMessageForwardFees(
    msgPrices: ReturnType<typeof configParseMsgPrices>,
    msg: Message
) {
...
export function setMsgPrices(
    configRaw: Cell,
    prices: ReturnType<typeof configParseMsgPrices>,
    workchain: 0 | -1
) {
    const config = configRaw
        .beginParse()
