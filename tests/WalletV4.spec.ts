...
describe('Wallet V4 Gas Measurement', () => {
    ...
    beforeAll(async () => {
        console.log('Using official @ton/ton Wallet V4 wrapper');
    ...
    beforeEach(async () => {
        ...
        GAS_LOG.rememberBocSize('WalletV4', walletV4.init.code);
    });
    ...
    it('[bench] V4: batch transfer (2 messages)', async () => {
        const deployer = await blockchain.treasury('deployer');
        await deployer.send({ to: walletV4.address, value: toNano('1'), init: walletV4.init });
        ...
        console.log('\n========================================');
        console.log('  Wallet V4: Batch Transfer (2 msgs)');
        console.log('========================================\n');
